...
Il s'agit ici de registres d'une architecture 16 bits. Les registres 32 et 64 bits sont présentés au cours des différents chapitres.
...
* D pour Données (Data) : utilisé lors des opérations d’entrées/sorties, sert également conjointement au registre Accumulateur afin de stocker des informations de calcul arithmétique (extension de l’accumulateur).
...
![Découpage registre EAX](images/decoupage_registre_EAX.png)
