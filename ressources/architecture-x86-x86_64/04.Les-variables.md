...
**Note :** Il est intéressant de voir qu'une variable globale initialisée à la valeur "0" sera stockée dans la section _bss_ et non _data_. En fait, toutes les variables globales ayant pour valeur 0 ou NULL sont stockées dans la section _bss_. Les variables globakes non initialisées sont implicitement mises à "0" (ou _NULL_ pour les pointeurs) et sont donc également stockées dans la section _bss_.
